...
public class MySQLDaoImpl {
    ...
    public boolean isDateInTodayAdsets(java.util.Date date, int accountId, String campaignId, String adsetId) {
        System.out.println(date);
        Session session = sessionFactory.openSession();
        try {
            session.createQuery("from AdsetEntity where date=:date and account_id=:accountId and campaign_id=:campaignId and adset_id=:adsetId", AdsetEntity.class)
